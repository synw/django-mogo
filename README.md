...
Initiate the instance:
  ...
  ```bash
wget https://raw.githubusercontent.com/synw/django-mogo/master/initiate.sh
chmod a+x initiate.sh
./initiate.sh PROJECT_NAME
rm -f initiate.sh
  ```
Or just run classical migrations management commands.
