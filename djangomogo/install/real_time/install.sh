...
check "Real time package installed: you still have to get Centrifugo and generate its config, as well as django-presence
config and update manualy settings.py. Check django-instant and django-presence doc."
